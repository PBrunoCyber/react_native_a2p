        ...
        <View style={{ marginTop: 20 }}>
            ...
            {isClicked === true || Object.keys(formErrors).length > 0 ?
                <View style={styles.formContainer}>
                    ...
                    <RadioGroup options={[1, 0]} disable={answer.campo_116 === 1 || answerEquipamentos?.campo_92 === 0 || (!answerQuantidadeEquipamentos?.campo_103 || !answerQuantidadeEquipamentos.campo_104 || !answerQuantidadeEquipamentos.campo_105)  ? true : false} value={answer.campo_114} textOption={textOption} fontWeight='normal' question='1 - A cabo*' onSelect={(option) => handleOptionChange('campo_114', option)} />
