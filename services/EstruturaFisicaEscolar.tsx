...
const createTBEstruturaFisicaEscolar = () => {
    return new Promise((resolve, reject) => {
        db.transaction((tx) => {
            tx.executeSql("CREATE TABLE tb_estrutura_escolar" +
                ...
                + "campo_169 INTEGER" +
                + "campo_170 INTEGER" +
                + "inep_fk VARCHAR(8) FOREIGN KEY(inep_fk) REFERENCES escola(inep)" +
                ")",
                [],
                (_, { rows }) => {
...
const existsEstruturaFisicaEscolar = () => {
    return new Promise((resolve, reject) => {
        db.transaction((tx) => {
            tx.executeSql("SELECT 1 FROM tb_estrutura_escolar;",
                [],
                (_, { }) => {
                    resolve(true);
                },
